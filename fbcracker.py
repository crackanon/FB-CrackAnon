...
def login():
    ...
    try:
        ...
        os.system('clear')
        print banner2
        print G+'    Login Your Fuckin Account'+N
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.facebook.com/crackanon')
                time.sleep(1)
                menu()
...
def pilih():
    zedd = raw_input(G + 'im a cancer ' + R + '\xe2\x96\xb6 ' + W)
    if zedd == '':
        ...
        os.system('clear')
        print ' \033[1;93mRecoded : \033[1;92mCYBER ANONS PH - Kali Duckduckgo\n \033[1;93mAlyas : \033[1;92mCyberAnon \n \033[1;93mFacebook : \033[1;92mhttps://www.facebook.com/crackanon \n\033[1;93m Github : \033[1;92mv \n\033[1;93m YouTube : \033[1;92mhttps://youtube.com/crackanon'
        print '\n'
        print G+' Special Greets:'+V+' \n  \n \n Pinoy-Recovery \n  \n  \n X-Protocol \n  \n CyberAnon\n  \n '
        ...
        os.system('clear')
        print G + 'CyberAnon Kill At You <3'+N
...
def turn():
    g = raw_input(G+'im a cancer'+R+' \xe2\x96\xb6 '+W)
    if g == '1' or g == '01':
        On = 'true'
        gaz(toket, On)
    else:
...
def pilih_super():
    peak = raw_input(G + ' im a cancer\x1b[1;91m >\x1b[1;97m ')
    if peak == '':
        print '\x1b[1;91m[!] Empty command'
        pilih_super()
    elif peak == '1':
